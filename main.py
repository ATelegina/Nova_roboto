...
def chat_m(message: types.ChatMemberUpdated):
    malnovulo = message.old_chat_member
    novulo = message.new_chat_member
    if novulo.status == "member":
        bot.send_message(message.chat.id, 'Bonvenon! Mi estas roboto. Sendu al mi mesaĝon, tajpu "Jes" kaj vidu magion💫')
